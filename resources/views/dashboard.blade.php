...
$dashboard_elems = [
        ...
        route('audio.create') => ['add_audio_file', 'Añadir audio', ['empleado','admin']],
        route('audio.index') => ['audio_file', 'Audios', ['empleado','admin']],
        route('video.create') => ['add_video_file','Añadir vídeos',['empleado','admin']],
        route('video.index') => ['video_file','Vídeos',['empleado','admin']],
        route('language.create') => ['add_globe','Añadir idioma',['empleado','admin']],
